...
class Persona
{
    ...
    public function modificar()
    {
        ...
        $query = "UPDATE persona SET 
            ...
            fechaNac='" . $this->getfechaNacimiento() . "', Telefono='" . $this->getTelefono() . "', 
        ...
        if ($db->Iniciar()) {
            if ($db->Ejecutar($query)) {
                ...
                $this->setMensajeoperacion("ERROR::Persona => modificar ejecutar: " . $db->getError());
            }
        } else {
            $this->setMensajeoperacion("ERROR::Persona => modificar insertar: " . $db->getError());
        }
        return $resp;
    }
